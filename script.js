// frontend/script.js
const API_URL = "http://localhost:8000/predict"; // change to your deployed backend URL
...
form.addEventListener('submit', async (e) => {
  ...
  const payload = {
    ...
    account_age_days: Number(document.getElementById('accAge').value) || 0,
    ...
    username_digit_ratio: Number(document.getElementById('usernameDigitRatio').value) || 0,
    username_length: Number(document.getElementById('usernameLength').value) || 0,
    ...
    profile_completeness: Number(document.getElementById('profileCompleteness').value) || 0,
    posts_per_day_avg: Number(document.getElementById('postRate').value) || 0,
    pct_posts_duplicate_content: Number(document.getElementById('dupRatio').value) || 0,
